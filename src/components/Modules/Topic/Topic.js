    ...
    return (
        <React.Fragment>
            <div style={{ background: "#f7f9fb", width: "1130px", height: "638px", position: "absolute", top: "110px", left: "308px" }}>
                ...
                <div className='a' style={{ display: "flex", flexDirection: "row", justifyContent: "center", paddingRight: "2px" }}>
                    <div style={{ background: "white", borderTop: "1px solid #a4cae9", borderLeft: "1px solid #a4cae9", borderRight: "1px solid #a4cae9", borderRadius: "4px 4px 0 0", display: "flex", flexDirection: "row", alignItems: "center", boxShadow: "2px 0 0 0 rgba(0, 0, 0, 0.1)", paddingLeft: "18px", paddingRight: "15px" }}>
                ...
                <div style={{ display: "flex", justifyContent: "center" }}>
                    <div style={{ background: "#ffffff", height: "400px", width: "700px", borderLeft: "1px solid #a4cae9", borderRight: "1px solid #a4cae9", borderBottom: "1px solid #a4cae9", borderRadius: "0 4px 4px 4px", boxSizing: "border-box", paddingLeft: "50px" }}>
